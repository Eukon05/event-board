...
public enum Result {
    ...
    USER_ALREADY_INVITEE(HttpStatus.BAD_REQUEST, "The given user is already invited to the given event"),
    USER_ALREADY_ATTENDEE(HttpStatus.BAD_REQUEST, "The given user is already attending the given event"),
